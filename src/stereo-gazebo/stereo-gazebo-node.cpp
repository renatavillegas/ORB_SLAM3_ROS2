#include "stereo-gazebo-node.hpp"
...
:   Node("ORB_SLAM3_ROS2"),
    m_SLAM(pSLAM)
{
    std::cout << "Entrei em Node ============================ " << std::endl;
    ...
    std::cout << "Verifiquei retify ============================ " << std::endl;
    left_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(this, "/camera/left");
    std::cout << "left_sub ============================ " << std::endl;
    right_sub = std::make_shared<message_filters::Subscriber<ImageMsg> >(this, "/camera/right");
    std::cout << "right_sub ============================ " << std::endl;
    syncApproximate = std::make_shared<message_filters::Synchronizer<approximate_sync_policy> >(approximate_sync_policy(100), *left_sub, *right_sub);
